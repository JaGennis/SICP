...
; In contrast to 'if', 'new-if' is treated like a procedure by the interpreter.
; Therefore the applicate-order evaluation will recursively try to expand
; 'sqrt-iter' which will lead to an infinite loop.
