...
; The applicative-order evaluation will try to evalute p, which is defined by
; itself and therefore will lead into an infinite loop.

; The normal-order evaluation will first expand the compound expression 'test'.
; Since the fist condition of the if-statement evaluates to true, the
